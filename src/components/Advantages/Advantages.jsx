...
const DUMMY_ADV = [
    {id: 1, name: "one", pic: avatar1, text: "YOU ARE FIRST"},
    {id: 2, name: "two", pic: avatar2, text: "YOU ARE SECOND"},
    {id: 3, name: "three", pic: avatar1, text: "YOU ARE THIRD"},
    {id: 4, name: "four", pic: avatar2, text: "YOU ARE FOURTH"},
    {id: 5, name: "five", pic: avatar1, text: "YOU ARE FIVTH"}
];

const Advantages = () => {

    const [picture, setPicture] = useState(avatar1)
    const [text, setText] = useState("YOU ARE FIRST");
