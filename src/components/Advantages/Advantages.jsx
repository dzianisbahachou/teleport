...
const DUMMY_ADV = [
    ...
    {id: 2, name: "two", pic: "/assets/mini2.png", title: "Захватывающие сценарии", text: "Мы адаптируем программы под возраст и количество участников и подбираем такие форматы, которые понравятся всем гостям праздника. Это и театрализованные представления, шоу и конкурсы, дополнения к празднику, количество которых может быть ограничено только вашей фантазией"},
    ...
    {id: 4, name: "four", pic: "/assets/mini2.png", title: "Репетиции каждую неделю", text: "Чтобы создать волшебную атмосферу, наша команда каждую неделю собирается на офисе и начинается волшебство. Ведь вжиться в роль непросто! Актеры изучают сценарий программы, поют, танцуют и импровизируют, чтобы праздник прошел как в сказке."},
    {id: 5, name: "five", pic: "/assets/mini.png", title: "Качество не привязано к стоимости", text: "Наша главная задача – создать праздник, о котором Ваш малыш и его гости вспоминали бы с удовольствием. Ради этого мы будем выкладываться по полной. И совсем неважно, что организуем для вас – экспресс-поздравление на 30 минуток или праздник на 5 часов. Все пройдет безупречно!"}
];
